...
/******/ 	var hotCurrentHash = "d718b27abe38fb3d1e16"; // eslint-disable-line no-unused-vars
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_04c2046b_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_App_vue__ = __webpack_require__(15);
var disposed = false
...
var update = __webpack_require__(11)("2a193c38", content, false);
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _vm._l(_vm.$data.todos.filter(_vm.shouldShowTodo), function(todo) {
        return _c("ul", { key: todo.key }, [
          _c("li", { class: { complete: todo.done } }, [
            _vm._v("\n            " + _vm._s(todo.text) + "\n            "),
            _c("input", {
              directives: [
                {
      ...
      _vm._v(" "),
      _c("label", { staticClass: "show-completed" }, [
        ...
        _c("input", {
          ...
          attrs: { type: "checkbox" },
          domProps: {
            checked: Array.isArray(_vm.showDone)
              ? _vm._i(_vm.showDone, null) > -1
              : _vm.showDone
          },
          on: {
            change: function($event) {
...
if (true) {
  module.hot.accept()
  if (module.hot.data) {
    __webpack_require__(3)      .rerender("data-v-04c2046b", esExports)
  }
}
